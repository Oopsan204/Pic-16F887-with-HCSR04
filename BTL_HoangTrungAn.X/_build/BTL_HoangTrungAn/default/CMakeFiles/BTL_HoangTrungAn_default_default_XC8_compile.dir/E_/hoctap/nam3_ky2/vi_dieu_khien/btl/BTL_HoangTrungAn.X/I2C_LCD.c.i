...
# 2 "<built-in>" 2
# 1 "E:\\hoctap\\nam3_ky2\\vi_dieu_khien\\btl\\BTL_HoangTrungAn.X\\I2C_LCD.c" 2
...
void LCD_Init(unsigned char I2C_Add)
{
    ...
    _delay((unsigned long)((30)*(12000000/4000.0)));
    LCD_CMD(0x03);
...
void LCD_Write_4Bit(unsigned char Nibble)
{
    ...
    _delay((unsigned long)((50)*(12000000/4000000.0)));
}
