...
float crystal_freq_mhz = 12.0;
float sound_speed_cms = 34300.0;
...
void SR04_trigger()
{
    ...
    RB1 = 0;
    _delay((unsigned long)((2)*(12000000/4000000.0)));
    RB1 = 1;
    _delay((unsigned long)((10)*(12000000/4000000.0)));
    RB1 = 0;
}

void SR04_Distance()
{
    unsigned int measurements[20] = {0};
    unsigned int sum = 0;
    ...
    else
    {
        ...
        {
            BUZZER_MultipleBeeps(3, 100, 100);
        }
        else if (distn < 30)
        {
            BUZZER_MultipleBeeps(2, 200, 100);
        }
        else
        {
            BUZZER_Beep(150);
...
void __attribute__((picinterrupt(("")))) echoTime()
{
    if (RBIF == 1)
    {

        if (RB0 == 1 && echo_state == 0)
        {
        ...
        else if (RB0 == 0 && echo_state == 1)
        {
            ...
            last_distance = TMR / division_factor;
